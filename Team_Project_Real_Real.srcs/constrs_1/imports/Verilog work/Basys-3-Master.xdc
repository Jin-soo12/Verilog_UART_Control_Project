...
set_property -dict { PACKAGE_PIN V3    IOSTANDARD LVCMOS33 } [get_ports {L_R_Mode_led[2]}]
set_property -dict { PACKAGE_PIN W3    IOSTANDARD LVCMOS33 } [get_ports {L_R_Mode_led[0]}]
#set_property -dict { PACKAGE_PIN U3    IOSTANDARD LVCMOS33 } [get_ports {led[11]}]
set_property -dict { PACKAGE_PIN P3    IOSTANDARD LVCMOS33 } [get_ports {L_R_Mode_led[1]}]
...
set_property -dict { PACKAGE_PIN J2   IOSTANDARD LVCMOS33 } [get_ports {dht11_io}];#Sch name = JA3
...
set_property -dict { PACKAGE_PIN M2   IOSTANDARD LVCMOS33 } [get_ports {trigger}];#Sch name = XA3_P
set_property -dict { PACKAGE_PIN N2   IOSTANDARD LVCMOS33 } [get_ports {echo}];#Sch name = XA4_P
